					...
					<div className="row">
						<div className="col-xl-4 col-lg-4 col-md-6">
							<div className="features-wrapper text-center mb-30">
								...
								<div className="features-text back">
									<h4>היסטוריית מוצרים</h4>
									<p>
										בעמוד הזה תוכלו לראות את כל המוצרים שסרקתם אי פעם ולמיין אותם לפי תאריך
									</p>
                                    <div className="features-img">
									{/* <img height="100px" src={require("../Assets/scan.jpeg").default} alt="features"/> */}
								</div>
